...
function getRandomIntInclusive(min, max) {
  ...
  return Math.floor(Math.random() * (nMax - nMin + 1) + nMin); // The maximum is inclusive and the minimum is inclusive
}
...
function processRestaurants(list) {
  ...
  const range = [...Array(15).keys()]; // create array with 15 elements
